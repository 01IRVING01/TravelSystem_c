...
""));
        ...
        BudgetBox = new QComboBox(centralWidget);
        BudgetBox->setObjectName(QString::fromUtf8("BudgetBox"));
        sizePolicy4.setHeightForWidth(BudgetBox->sizePolicy().hasHeightForWidth());
        BudgetBox->setSizePolicy(sizePolicy4);
        BudgetBox->setMaxVisibleItems(12);

        gridLayout_2->addWidget(BudgetBox, 0, 4, 1, 1);
        ...
        cityFeaturesBox = new QComboBox(centralWidget);
        cityFeaturesBox->setObjectName(QString::fromUtf8("cityFeaturesBox"));
        sizePolicy4.setHeightForWidth(cityFeaturesBox->sizePolicy().hasHeightForWidth());
        cityFeaturesBox->setSizePolicy(sizePolicy4);
        cityFeaturesBox->setMaxVisibleItems(12);

        horizontalLayout_5->addWidget(cityFeaturesBox);
...
"}"));
        ...
        passengerBox->setAutoFillBackground(false);
        passengerBox->setStyleSheet(QString::fromUtf8("background-color: rgb(215, 207, 194);"));
...
"background-color: rgb(215, 207, 194);\n"
"border-radius: 10px;"));
...
"border-radius: 10px;"));
        ...
        FeatureList = new QTableWidget(centralWidget);
        if (FeatureList->rowCount() < 2)
            FeatureList->setRowCount(2);
        QTableWidgetItem *__qtablewidgetitem = new QTableWidgetItem();
        FeatureList->setVerticalHeaderItem(0, __qtablewidgetitem);
        QTableWidgetItem *__qtablewidgetitem1 = new QTableWidgetItem();
        FeatureList->setVerticalHeaderItem(1, __qtablewidgetitem1);
        FeatureList->setObjectName(QString::fromUtf8("FeatureList"));
        QSizePolicy sizePolicy13(QSizePolicy::Expanding, QSizePolicy::Expanding);
        sizePolicy13.setHorizontalStretch(0);
        sizePolicy13.setVerticalStretch(1);
        sizePolicy13.setHeightForWidth(FeatureList->sizePolicy().hasHeightForWidth());
        FeatureList->setSizePolicy(sizePolicy13);
        FeatureList->setStyleSheet(QString::fromUtf8("font: 75 10pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";\n"
""));
        FeatureList->setRowCount(2);
        FeatureList->setColumnCount(0);
        FeatureList->horizontalHeader()->setVisible(false);
        FeatureList->horizontalHeader()->setMinimumSectionSize(60);
        FeatureList->horizontalHeader()->setDefaultSectionSize(60);
        FeatureList->verticalHeader()->setMinimumSectionSize(60);
        FeatureList->verticalHeader()->setDefaultSectionSize(60);
        FeatureList->verticalHeader()->setHighlightSections(false);

        rightLayout->addWidget(FeatureList, 1, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        destinationLabel->setText(QCoreApplication::translate("MainWindow", "\346\227\205\350\241\214\351\242\204\347\256\227", nullptr));
        BudgetBox->setCurrentText(QString());
        ...
        passLable->setText(QCoreApplication::translate("MainWindow", "\345\205\264\350\266\243", nullptr));
        cityFeaturesBox->setCurrentText(QString());
        label->setText(QCoreApplication::translate("MainWindow", "\346\234\237\346\234\233\345\200\274", nullptr));
        visitTime->setSuffix(QCoreApplication::translate("MainWindow", " Level", nullptr));
        ...
        QTableWidgetItem *___qtablewidgetitem = FeatureList->verticalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("MainWindow", "\345\205\264\350\266\243", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = FeatureList->verticalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("MainWindow", "\346\234\237\346\234\233\345\200\274", nullptr));
    } // retranslateUi
